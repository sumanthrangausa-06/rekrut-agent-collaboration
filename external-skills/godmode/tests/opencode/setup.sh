...
mkdir -p "$HOME/.config/opencode/godmode"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/godmode/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/godmode/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/godmode/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/godmode.js" "$HOME/.config/opencode/godmode/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/godmode/.opencode/plugins/godmode.js" \
       "$HOME/.config/opencode/plugins/godmode.js"
...
echo "Plugin installed to: $HOME/.config/opencode/godmode/.opencode/plugins/godmode.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/godmode.js"
